...
$fragm_cache_key_build['buildid'] = get_option( 'molswc_fragment_cache_buildid' ); // a rebuild option, just increase this number and all transients will become obsolete (but not deleted from DB, so beware!)
