...
// get rid of original JS from WC Variations Price Hints ... 
...
// ... and add a new JS for Variations Price Hints, which we'll customize to work with buttons :-)
function molswc_readd_wcvarhints_js() {
	wp_register_script('wm_variation_price_hints_script', plugins_url('price-hints-script.js', __FILE__), array('jquery'), '', true);
	wp_enqueue_script('wm_variation_price_hints_script');
}
add_action( 'wp_enqueue_scripts', 'molswc_readd_wcvarhints_js'); 
